...
PowerShell modules and functions follow different naming conventions.

### Module Naming

Module filenames represent a domain concept or responsibility.
...
Functions must use approved PowerShell verbs and follow the Verb-Noun convention.
...
Functions responsible for creating models must use the `New-` verb.
...
Models do not read files, validate data, or perform business logic.

### Services

Provide access to external resources such as the file system or JSON serialization.
...
Core components coordinate models, services, and validators.

### Validators

Validate data and business rules.

Validators should not modify data.

### Bootstrappers

Execute installation tasks using the validated configuration.

## Bootstrappers should not be responsible for loading or validating configuration.
